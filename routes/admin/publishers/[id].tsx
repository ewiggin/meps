...
export default function PublisherView() {
    return (
        <>
            <Breadcrumb title={`Publicadores - Perfil`} backLink={"/admin/publishers"}></Breadcrumb>
        <div
            ...
            <div class="p-4 border-t mx-8 mt-2">
                <button class="w-1/2 block mx-auto rounded-full bg-gray-900 hover:shadow-lg font-semibold text-white px-6 py-2">Contactar</button>
            </div>
        </div>
        </>
    );
