        ...
        <section className="relative flex flex-wrap lg:h-screen lg:items-center">
          <div className="w-full px-4 py-12 sm:px-6 sm:py-16 lg:w-1/2 lg:px-8 lg:py-24">
            <div className="mx-auto max-w-lg text-center">
              <h1 className="text-2xl font-bold sm:text-3xl">MEPS - Gestión de mapas</h1>

              <p className="mt-4 text-gray-500">
                Para poder acceder a esta sección es necesario que te identifiques como administrador
              </p>
            </div>

            <form action="" method="post" className="mx-auto mb-0 mt-8 max-w-md space-y-4">
              <div>
